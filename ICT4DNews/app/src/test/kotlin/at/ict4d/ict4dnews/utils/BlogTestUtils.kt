...
fun generateFeedType(): FeedType =
    when (generateRandomNumber(3)) {
        1 -> FeedType.RSS
...
fun generateActive(): Boolean =
    when (generateRandomNumber(2)) {
        1 -> true
        2 -> false
        else -> true
    }

fun generateBlog(active: Boolean = generateActive()) =
    Blog(
        generateRandomURL(),
        generateRandomURL(),
        generateUUID(),
...
fun generateBlogAndInsert(
    blogDao: BlogDao,
    active: Boolean = generateActive(),
): Blog {
