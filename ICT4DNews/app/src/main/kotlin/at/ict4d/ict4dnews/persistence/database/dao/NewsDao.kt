...
abstract class NewsDao {
    ...
    @Query(
        """
        SELECT $NEWS_TABLE_TABLE_NAME.$NEWS_TABLE_LINK, $NEWS_TABLE_TABLE_NAME.$NEWS_TABLE_AUTHOR_ID, $NEWS_TABLE_TABLE_NAME.$NEWS_TABLE_SERVER_ID, $NEWS_TABLE_TABLE_NAME.$NEWS_TABLE_FEATURED_MEDIA, $NEWS_TABLE_TABLE_NAME.$NEWS_TABLE_TITLE, $NEWS_TABLE_TABLE_NAME.$NEWS_TABLE_PUBLISHED_DATE, $NEWS_TABLE_TABLE_NAME.$NEWS_TABLE_BLOG_ID
